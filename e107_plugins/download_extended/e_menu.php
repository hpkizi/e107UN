...
e107::lan("download_extended", true);

class download_extended_menu
{
	...
	public function config($menu='')
	{
		...
		switch($menu)
		{
			...
			$fields['menuTableStyle']   = array('title'=> LAN_JMD_HELP_LAN_24, 'type'=>'text', 'writeParms'=>array('size'=>'xxlarge', 'default'=>'' )); 
